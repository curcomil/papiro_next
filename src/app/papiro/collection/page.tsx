...
const FILTER_ITEM = {
  nombre: "item",
  filtros: [
    { label: "Autor", value: "dc_metadata.autor" },
    { label: "Tipología", value: "papiro_data.tipo_de_objeto" },
    { label: "Descripción", value: "dc_metadata.descripcion" },
    { label: "Notas", value: "papiro_data.notas" },
    { label: "Referencia", value: "papiro_data.referencia_control" },
    { label: "Palabras clave", value: "papiro_data.keywords" },
  ],
};
    ...
    amcService
      ...
      .then((data) => {
        if (data?.data[0]?.type === "item") {
          ...
          setRespuestaTypeItem(false);
          setCarpetas(data.data);
          setCarpetaSeleccionada(data.data[0] ?? null);
        }
